...
namespace Microsoft.Store.PartnerCenter.CustomerApplication.Configuration.Manager
{
    using System;
    ...
    public class StandardWebPortalConfigurationManager : WebPortalConfigurationManager
    {
        ...
        public override async Task<PluginsSegment> GeneratePlugins()
        {
            ...
            return await Task.FromResult<PluginsSegment>(this.Configuration.Plugins);
        }
